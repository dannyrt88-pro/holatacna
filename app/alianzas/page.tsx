...
const allianceCategories = [
  {
    title: 'Clinicas',
    description:
      'Para clinicas dentales, oftalmologicas, esteticas y centros medicos que deseen formar parte de la red.',
    href: '/alianzas/clinicas',
  },
  {
    title: 'Hoteles y alojamientos',
    description:
      'Para hoteles, hostales y hospedajes que puedan recibir visitantes y acompanantes durante su estancia en Tacna.',
    href: '/alianzas/hoteles',
  },
  {
    title: 'Transporte',
    description:
      'Para servicios de traslado que puedan apoyar movilidad entre frontera, terminales, hospedajes y centros de atencion.',
    href: '/alianzas/transporte',
  },
  {
    title: 'Restaurantes',
    description:
      'Para negocios gastronomicos que quieran formar parte de una red confiable para visitantes de Chile.',
    href: '/alianzas/restaurantes',
  },
  {
    title: 'Departamentos por dia',
    description:
      'Para opciones de alojamiento temporal que puedan ofrecer una estadia practica y ordenada durante el viaje.',
      ...
      <div className="mx-auto max-w-6xl">
        <section className="mb-6 rounded-[32px] bg-[linear-gradient(135deg,#082f49_0%,#155e75_50%,#15803d_100%)] px-8 py-12 text-white shadow-xl sm:px-10 sm:py-14">
          ...
          <h1 className="max-w-4xl text-4xl font-bold leading-tight sm:text-5xl">
            Alianzas con proveedores y aliados en Tacna
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-8 text-white/85 sm:text-lg">
            HolaTacna esta construyendo una red de servicios confiables en Tacna para pacientes y
            visitantes del norte de Chile. Si tienes un negocio en la ciudad, puedes conocer como
            formar parte de la red de aliados.
          </p>
        ...
        <section className="mb-6 rounded-[28px] bg-white p-8 shadow-lg sm:p-10">
          ...
          <h2 className="text-3xl font-bold sm:text-4xl">Explora alianzas por categoria</h2>
          <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {allianceCategories.map((category) => (
              ...
              >
                ...
                <Link
                  href={category.href}
                  className="mt-6 inline-flex rounded-xl bg-slate-950 px-4 py-3 font-semibold text-white transition hover:bg-slate-800"
                >
                  Ver alianza
                </Link>
              </article>
        ...
        <section className="mb-6 rounded-[28px] bg-white p-8 shadow-lg sm:p-10">
          ...
          <h2 className="text-3xl font-bold sm:text-4xl">
            Una red de servicios para visitantes del norte de Chile
          </h2>
          <p className="mt-4 max-w-4xl text-base leading-8 text-slate-600 sm:text-lg">
            Cada año muchas personas del norte de Chile viajan a Tacna por atencion medica,
            estadias breves y distintos servicios de apoyo durante su visita.
          </p>
          <p className="mt-3 max-w-4xl text-base leading-8 text-slate-600 sm:text-lg">
            HolaTacna busca organizar ese flujo conectando visitantes con servicios confiables en la
            ciudad.
          </p>
        </section>
        ...
        <section className="mb-6 rounded-[28px] border border-emerald-200 bg-[linear-gradient(180deg,#ecfdf5_0%,#ffffff_100%)] p-8 shadow-lg sm:p-10">
          ...
          <p className="max-w-4xl text-base leading-8 text-slate-700 sm:text-lg">
            Nuestro objetivo es construir una red de aliados clara y confiable. Cada proveedor
            comparte informacion basica para poder ser considerado dentro de la red.
          </p>
        </section>

        <section className="rounded-[32px] bg-slate-950 px-8 py-10 text-white shadow-xl sm:px-10 sm:py-12">
          <h2 className="text-3xl font-bold sm:text-4xl">Tienes un negocio en Tacna?</h2>
          <p className="mt-4 max-w-3xl text-base leading-8 text-white/80 sm:text-lg">
            Puedes postular para formar parte de la red de aliados de HolaTacna.
          </p>
          <div className="mt-8">
            <Link
              href="/registro-proveedores"
