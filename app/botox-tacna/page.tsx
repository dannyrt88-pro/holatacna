...
const benefits = [
  ...
  'Informacion clara para comparar botox facial en Tacna.',
  'Coordinacion previa con especialistas de medicina estetica facial.',
  'Apoyo para resolver dudas sobre zonas de aplicacion y tiempos.',
]

const treatmentScope = [
  'Evaluacion para botox facial',
  'Consulta sobre lineas de expresion',
  'Revision de zonas de aplicacion',
  'Orientacion sobre tiempos y cuidados posteriores',
]

const steps = [
  'Dejas tu consulta y la zona facial que deseas evaluar.',
  'HolaTacna revisa tu caso y ordena una orientacion inicial.',
  'Se coordina el contacto con el especialista en Tacna.',
]

export const metadata: Metadata = {
  title: 'Botox en Tacna para pacientes chilenos | HolaTacna',
  description:
    'Conoce opciones de botox en Tacna para pacientes de Chile que evaluan tratamientos de medicina estetica facial antes de viajar.',
}

export default function BotoxTacnaPage() {
  return (
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              ...
              <h1 className="mb-4 text-4xl font-bold leading-tight sm:text-5xl">
                Botox en Tacna para pacientes chilenos
              </h1>
              <p className="mb-6 text-lg leading-8 text-slate-600 sm:text-xl">
                Conoce opciones de botox en Tacna para pacientes de Chile que buscan un tratamiento
                especifico de medicina estetica facial con orientacion previa.
              </p>
              <Link
        ...
        <div className="mx-auto max-w-3xl rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
          ...
          <Suspense fallback={<div className="text-sm text-slate-500">Cargando formulario...</div>}>
            <LeadCaptureForm
              serviceSlug="botox"
              serviceName="Botox"
              landingPath="/botox-tacna"
              pageType="seo"
              variant="primary"
              heading="Solicitar evaluacion"
              submitLabel="Solicitar evaluacion"
              messageLabel="Mensaje"
              messagePlaceholder="Cuentanos si deseas evaluar botox facial, resolver dudas sobre zonas de aplicacion o conocer el proceso antes de viajar."
