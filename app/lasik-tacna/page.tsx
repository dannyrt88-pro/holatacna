...
const benefits = [
  ...
  'Informacion clara para comparar cirugia Lasik en Tacna.',
  'Coordinacion previa por WhatsApp con clinicas oftalmologicas verificadas.',
  'Apoyo para resolver dudas sobre evaluacion y recuperacion.',
]

const treatmentScope = [
  'Evaluacion para Lasik',
  'Correccion de miopia y astigmatismo',
  'Revision de examenes previos',
  'Orientacion sobre tiempos de recuperacion',
]
...
export const metadata: Metadata = {
  title: 'Lasik en Tacna para pacientes chilenos | HolaTacna',
  description:
    'Conoce opciones de cirugia Lasik en Tacna para pacientes de Chile que buscan corregir su vision con orientacion previa antes de viajar.',
}

export default function LasikTacnaPage() {
  return (
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              ...
              <h1 className="mb-4 text-4xl font-bold leading-tight sm:text-5xl">
                Lasik en Tacna para pacientes chilenos
              </h1>
              <p className="mb-6 text-lg leading-8 text-slate-600 sm:text-xl">
                Conoce opciones de cirugia Lasik en Tacna para pacientes de Chile que buscan
                orientacion previa antes de viajar.
              </p>
              <Link
        ...
        <div className="mx-auto max-w-3xl rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
          ...
          <Suspense fallback={<div className="text-sm text-slate-500">Cargando formulario...</div>}>
            <LeadCaptureForm
              serviceSlug="lasik"
              serviceName="Lasik"
              landingPath="/lasik-tacna"
              pageType="seo"
              variant="primary"
              heading="Solicitar evaluacion"
              submitLabel="Solicitar evaluacion"
              messageLabel="Mensaje"
              messagePlaceholder="Cuentanos si deseas evaluar cirugia Lasik, corregir miopia, astigmatismo u otra consulta visual antes de viajar."
