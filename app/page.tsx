      ...
      <div className="mx-auto max-w-6xl">
        <section className="mb-6 rounded-[32px] bg-[linear-gradient(135deg,#082f49_0%,#0f3f8c_58%,#14b8a6_100%)] px-8 py-12 text-white shadow-xl sm:px-10 sm:py-14">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/tratamientos"
              className="rounded-2xl bg-emerald-400 px-6 py-4 font-bold text-emerald-950 shadow-[0_14px_30px_rgba(34,197,94,0.24)] transition hover:bg-emerald-300"
            >
              Ver tratamientos
            </Link>
            <Link
              href="/como-funciona"
              className="rounded-2xl bg-white px-6 py-4 font-bold text-sky-800 shadow-[0_14px_30px_rgba(255,255,255,0.16)] transition hover:bg-sky-50"
            >
              ¿Cómo funciona?
            </Link>
          </div>
        ...
        <section className="mb-6 rounded-[28px] bg-white p-8 shadow-lg sm:p-10">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600 sm:text-lg">
              Revisa las principales opciones médicas que pacientes del norte de Chile evalúan en
              Tacna antes de viajar.
            </p>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {medicalServices.map((service) => (
              ...
              >
                ...
                <Link
                  href={service.href}
                  className="mt-6 inline-flex rounded-xl bg-emerald-500 px-4 py-3 font-bold text-emerald-950 transition hover:bg-emerald-400"
                >
                  Ver información
                </Link>
              </article>
        ...
        <section className="mb-6 rounded-[28px] bg-white p-8 shadow-lg sm:p-10">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            ...
            <h2 className="text-3xl font-bold sm:text-4xl">
              Explora tratamientos por ciudad de origen
            </h2>
            <p className="mt-3 text-base leading-7 text-slate-600 sm:text-lg">
              Revisa opciones pensadas para pacientes que viajan desde Arica, Iquique y Antofagasta.
            </p>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {cityAccess.map((item) => (
              ...
              >
                <div className="mb-3 inline-flex rounded-full bg-emerald-100 px-3 py-1 text-xs font-bold uppercase tracking-[0.08em] text-emerald-700">
                  {item.city}
                </div>
        ...
        <section className="mb-6 rounded-[28px] bg-[linear-gradient(180deg,#f8fafc,#eef2ff)] p-8 shadow-lg sm:p-10">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            <div className="mb-4 inline-flex rounded-full bg-indigo-100 px-3 py-1 text-xs font-bold uppercase tracking-[0.16em] text-indigo-700">
              Proceso
            </div>
            <h2 className="text-3xl font-bold sm:text-4xl">¿Cómo funciona HolaTacna?</h2>
          </div>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/como-funciona"
              className="inline-flex rounded-2xl bg-slate-950 px-6 py-4 font-bold text-white transition hover:bg-slate-800"
            >
        ...
        <section className="mb-6 rounded-[28px] bg-white p-8 shadow-lg sm:p-10">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            ...
            <h2 className="text-3xl font-bold sm:text-4xl">Servicios aliados para tu viaje a Tacna</h2>
            <p className="mt-3 text-base leading-8 text-slate-600 sm:text-lg">
              Además de la atención médica, HolaTacna está construyendo una red de servicios
              aliados para ayudar a pacientes y visitantes a organizar mejor su estadía en Tacna.
            </p>
          </div>
        ...
        <section className="mb-6 rounded-[28px] border border-slate-200 bg-white p-8 shadow-lg sm:p-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="text-2xl font-bold sm:text-3xl">¿Tienes un negocio en Tacna?</h2>
            <p className="mt-3 text-base leading-7 text-slate-600 sm:text-lg">
              Conoce la red de aliados de HolaTacna.
            </p>
            <div className="mt-6">
              <Link
                href="/red"
        ...
        <section className="mb-6 rounded-[28px] border border-emerald-200 bg-[linear-gradient(180deg,#ecfdf5_0%,#ffffff_100%)] p-8 shadow-lg sm:p-10">
          ...
          <p className="mt-4 max-w-4xl text-base leading-8 text-slate-700 sm:text-lg">
            HolaTacna está construyendo una red de clínicas y servicios aliados para ayudar a
            pacientes del norte de Chile a organizar mejor su experiencia en la ciudad.
          </p>
        </section>

        <section className="rounded-[32px] bg-slate-950 px-8 py-10 text-white shadow-xl sm:px-10 sm:py-12">
          <h2 className="text-3xl font-bold sm:text-4xl">
            ¿Estás evaluando un tratamiento en Tacna?
          </h2>

          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/tratamientos"
              className="inline-flex rounded-2xl bg-emerald-400 px-6 py-4 font-bold text-emerald-950 transition hover:bg-emerald-300"
            >
              Ver tratamientos
            </Link>
            <Link
              href="/como-funciona"
              className="inline-flex rounded-2xl border border-white/20 bg-white/10 px-6 py-4 font-bold text-white transition hover:bg-white/15"
            >
              ¿Cómo funciona?
            </Link>
          </div>
