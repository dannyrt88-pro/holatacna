...
export default function AntofagastaDermatologiaTacnaPage() {
    ...
    try {
      const response = await fetch('/api/create-lead', {
        ...
        body: JSON.stringify({
          ...
          landing_path: '/antofagasta/dermatologia-tacna',
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              <div className="mb-4 inline-block rounded-full bg-sky-100 px-3 py-2 text-xs font-bold uppercase tracking-[0.12em] text-sky-700">
                Antofagasta y Tacna dermatologia
              </div>
              <h1 className="mb-4 text-4xl font-bold leading-tight sm:text-5xl">
                Dermatologia en Tacna para Pacientes de Antofagasta
              </h1>
              <p className="mb-6 text-lg leading-8 text-slate-600 sm:text-xl">
                Pacientes de Antofagasta viajan a Tacna para acceder a tratamientos dermatologicos
                mas accesibles y rapidos.
              </p>
              <p className="text-base leading-8 text-slate-600 sm:text-lg">
                Esta landing esta pensada para busquedas como dermatologia Tacna Antofagasta,
                dermatologo Tacna para pacientes de Antofagasta y tratamientos dermatologicos Tacna
                Antofagasta, con coordinacion previa por WhatsApp y enfoque comercial claro.
              </p>
              <button
                type="button"
                onClick={() =>
