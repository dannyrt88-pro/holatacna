...
export default function AntofagastaImplantesDentalesTacnaPage() {
    ...
    try {
      const response = await fetch('/api/create-lead', {
        ...
        body: JSON.stringify({
          ...
          landing_path: '/antofagasta/implantes-dentales-tacna',
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              <div className="mb-4 inline-block rounded-full bg-emerald-100 px-3 py-2 text-xs font-bold uppercase tracking-[0.12em] text-emerald-700">
                Antofagasta y Tacna dental
              </div>
              <h1 className="mb-4 text-4xl font-bold leading-tight sm:text-5xl">
                Implantes Dentales en Tacna para Pacientes de Antofagasta
              </h1>
              <p className="mb-6 text-lg leading-8 text-slate-600 sm:text-xl">
                Muchos pacientes de Antofagasta viajan a Tacna para acceder a tratamientos
                dentales mas accesibles y rapidos.
              </p>
              <p className="text-base leading-8 text-slate-600 sm:text-lg">
                Esta landing esta pensada para busquedas como implantes dentales Tacna
                Antofagasta, dentista Tacna para pacientes de Antofagasta e implantes dentales
                Tacna precio Antofagasta, con un enfoque comercial claro y coordinacion por
                WhatsApp.
              </p>
              <button
                type="button"
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              <h2 className="mb-4 text-2xl font-bold">
                Por que pacientes de Antofagasta eligen Tacna
              </h2>
      ...
      <section className="px-5 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[28px] border border-emerald-100 bg-emerald-50/70 p-8 shadow-[0_18px_40px_rgba(15,23,42,0.06)]">
            ...
            <h2 className="mb-4 text-3xl font-bold">Implantes dentales para pacientes de Antofagasta</h2>
            <p className="mb-4 text-base leading-8 text-slate-700 sm:text-lg">
              Muchos pacientes buscan una alternativa mas accesible para implantes dentales,
              evaluando dentista Tacna para pacientes de Antofagasta, tiempos de coordinacion y
              ahorro frente a Chile. HolaTacna ordena ese primer contacto de forma comercial y
              clara.
            </p>
