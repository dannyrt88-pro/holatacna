...
export default function IquiqueEsteticaTacnaPage() {
    ...
    try {
      const response = await fetch('/api/intake', {
        ...
        body: JSON.stringify({
          ...
          landing_path: '/iquique/estetica-tacna',
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              <div className="mb-4 inline-block rounded-full bg-pink-100 px-3 py-2 text-xs font-bold uppercase tracking-[0.12em] text-pink-700">
                Iquique y Tacna estetica
              </div>
              <h1 className="mb-4 text-4xl font-bold leading-tight sm:text-5xl">
                Estetica en Tacna para Pacientes de Iquique
              </h1>
              <p className="mb-6 text-lg leading-8 text-slate-600 sm:text-xl">
                Muchas pacientes de Iquique viajan a Tacna para acceder a tratamientos esteticos
                mas accesibles y rapidos.
              </p>
              <p className="text-base leading-8 text-slate-600 sm:text-lg">
                Esta landing esta pensada para busquedas como estetica Tacna Iquique, botox Tacna
                para pacientes de Iquique y tratamientos esteticos Tacna Iquique, con enfoque
                comercial claro y coordinacion por WhatsApp.
              </p>
              <button
                type="button"
                onClick={() =>
