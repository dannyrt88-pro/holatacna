...
const benefits = [
  ...
  'Solo minutos desde la frontera',
  'Atencion rapida',
...
const steps = [
  ...
  'Se coordina con clinica dental en Tacna',
  'Se agenda evaluacion',
]

export default function AricaImplantesDentalesTacnaPage() {
    ...
    try {
      const response = await fetch('/api/intake', {
        ...
        body: JSON.stringify({
          ...
          landing_path: '/arica/implantes-dentales-tacna',
          city_interest: 'arica',
        }),
      })
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              <div className="mb-4 inline-block rounded-full bg-emerald-100 px-3 py-2 text-xs font-bold uppercase tracking-[0.12em] text-emerald-700">
                Arica y Tacna dental
              </div>
              <h1 className="mb-4 text-4xl font-bold leading-tight sm:text-5xl">
                Implantes Dentales en Tacna para Pacientes de Arica
              </h1>
              <p className="mb-6 text-lg leading-8 text-slate-600 sm:text-xl">
                Muchos pacientes de Arica cruzan a Tacna para acceder a tratamientos dentales mas
                accesibles.
              </p>
              <p className="text-base leading-8 text-slate-600 sm:text-lg">
                Esta landing esta pensada para busquedas como implantes dentales Tacna Arica,
                dentista Tacna para pacientes de Arica e implantes dentales cerca de Arica, con un
                enfoque comercial claro y coordinacion por WhatsApp.
              </p>
              <button
                type="button"
                onClick={() =>
      ...
      <section className="px-5 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[28px] border border-emerald-100 bg-emerald-50/70 p-8 shadow-[0_18px_40px_rgba(15,23,42,0.06)]">
            ...
            <h2 className="mb-4 text-3xl font-bold">Implantes dentales cerca de Arica</h2>
            <p className="mb-4 text-base leading-8 text-slate-700 sm:text-lg">
              Muchos pacientes buscan una alternativa cercana para implantes dentales, evaluando
              dentista Tacna para pacientes de Arica, tiempos de coordinacion y ahorro frente a
              Chile. HolaTacna ordena ese primer contacto de forma comercial y clara.
            </p>
            <p className="text-base leading-8 text-slate-700 sm:text-lg">
              No prometemos resultados ni procedimientos cerrados desde esta pagina. Primero
              recibimos la consulta, revisamos el caso y coordinamos con una clinica verificada en
              Tacna cuando corresponde.
            </p>
          </div>
        </div>
      </section>
          ...
          <form onSubmit={handleSubmit} className="grid gap-4">
            ...
            <label className="grid gap-2">
              ...
              <textarea
                ...
                placeholder="Cuentanos que deseas consultar sobre implantes dentales en Tacna."
              />
            </label>
