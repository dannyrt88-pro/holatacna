...
const steps = [
  'Paciente de Arica deja sus datos',
  'HolaTacna revisa el caso',
  'Se coordina con clinica oftalmologica en Tacna',
  'Se agenda evaluacion',
]

export default function AricaOperacionOjosTacnaPage() {
    ...
    try {
      const response = await fetch('/api/create-lead', {
        ...
        body: JSON.stringify({
          ...
          landing_path: '/arica/operacion-ojos-tacna',
          city_interest: 'arica',
        }),
      })
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="rounded-[28px] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              <div className="mb-4 inline-block rounded-full bg-sky-100 px-3 py-2 text-xs font-bold uppercase tracking-[0.12em] text-sky-700">
                Arica y Tacna oftalmologia
              </div>
              <h1 className="mb-4 text-4xl font-bold leading-tight sm:text-5xl">
                Operacion de Ojos en Tacna para Pacientes de Arica
              </h1>
              <p className="mb-6 text-lg leading-8 text-slate-600 sm:text-xl">
                Muchos pacientes de Arica viajan a Tacna para acceder a atencion oftalmologica mas
                accesible y rapida.
              </p>
              <p className="text-base leading-8 text-slate-600 sm:text-lg">
                Esta landing esta pensada para busquedas como operacion ojos Tacna Arica,
                oftalmologia Tacna para pacientes de Arica y cirugia ocular Tacna Arica, con
                cercania con la frontera, coordinacion por WhatsApp y enfoque comercial claro.
              </p>
              <button
                type="button"
                onClick={() =>
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
              <h2 className="mb-4 text-2xl font-bold">Por que pacientes de Arica eligen Tacna</h2>
      ...
      <section className="px-5 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[28px] border border-emerald-100 bg-emerald-50/70 p-8 shadow-[0_18px_40px_rgba(15,23,42,0.06)]">
            ...
            <h2 className="mb-4 text-3xl font-bold">Oftalmologia en Tacna cerca de Arica</h2>
            <p className="mb-4 text-base leading-8 text-slate-700 sm:text-lg">
              Muchos pacientes de Arica buscan una alternativa cercana para consultas de
              oftalmologia, evaluacion visual y cirugia ocular en Tacna. HolaTacna ayuda a ordenar
              ese primer contacto con rapidez, claridad y coordinacion por WhatsApp.
            </p>
            <p className="text-base leading-8 text-slate-700 sm:text-lg">
              No prometemos procedimientos cerrados ni resultados especificos desde esta pagina.
              Primero recibimos la consulta, revisamos el caso y coordinamos con una clinica
              oftalmologica verificada en Tacna cuando corresponde.
            </p>
          </div>
        </div>
      </section>
          ...
          <form onSubmit={handleSubmit} className="grid gap-4">
            ...
            <label className="grid gap-2">
              ...
              <textarea
                ...
                placeholder="Cuentanos que deseas consultar sobre operacion de ojos u oftalmologia en Tacna."
              />
            </label>
